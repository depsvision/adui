<template>
  <div class="console-container">
    <div class="console-left-block">
      <div class="console-monitor-point console-common-block flex-column-class auto-flex-1">
        <div class="console-block-title">
          <span>监控点位</span>
          <common-cascader ref="commonCascader" class="console-monitor-point-cascader" :component-option="webcamMonitorOption" @handleChange="selectMonitorPoint" />
        </div>
        ...
        <div class="console-realtime-data flex-column-class auto-flex-1">
          ...
          <div
            ref="scrollBlock"
            class="console-realtime-data-block"
            @mouseenter="controlTimerAnimation(true)"
            @mouseleave="controlTimerAnimation(false)"
          >
            <transition-group
              v-infinite-scroll="loadRealtimeLastData"
              :infinite-scroll-disabled="noMoreRealtimeData"
            ...
            >
              <div
                v-for="data in realtime.data"
                :key="data.id"
                :style="data.style"
                class="console-realtime-data-item"
                @mousedown="openImageViewer(data)"
        ...
        <div class="console-right--top--left console-common-block flex-column-class">
          ...
          <div class="console-cluster-item-block">
            <div v-if="masterMenu.menuGroup.length >1" class="console-cluster-master">
              <common-menu ref="masterMenu" :component-option="masterMenu" @handleMenuItemClick="handleMenuItemClick" />
            </div>
                ...
                <template #scroll>
                  <div class="console-cluster-node-block">
                    <div
                      ...
                      :key="node.id"
                      :class="splitClass(node)"
                      class="console-cluster-node-item"
            ...
            >
              ...
              <div class="console-cluster-status-item-progress">
                <el-progress
                  ...
                  :stroke-width="statusProgressStrokeWidth"
                  stroke-linecap="butt"
          ...
          <div class="console-webcam-point">
            <div class="console-webcam-point-online auto-flex-1">
              <div class="console-online-block">
                <count-to
                  ref="online"
                  :start-val="webcamPoint.online.start"
                  :end-val="webcamPoint.online.end"
                  :autoplay="false"
                />
                <span>
            ...
            <div class="console-webcam-point-offline auto-flex-1">
              <div class="console-offline-block">
                <count-to
                  ref="offline"
                  :start-val="webcamPoint.offline.start"
                  :end-val="webcamPoint.offline.end"
                  :autoplay="false"
                />
                <span>
      ...
      <div class="console-right--bottom auto-flex-1">
        <div class="console-alarm-statistics console-common-block flex-column-class auto-flex-1">
          ...
          <div class="console-alarm-statistics-line auto-flex-1">
            <simple-chart :component-option="alarmStatisticsStandardTimeLine" @handleChartFun="handleChartFun" />
          </div>
          <div class="console-alarm-statistics-tool">
            ...
            <div class="alarm-statistics-tool-slider">
              ...
              <el-slider
                ref="lineSlider"
                v-model="alarmStatisticsOption.slider"
                :min="0"
                :max="100"
                :step="20"
                :disabled="alarmStatisticsOption.disabled"
                :format-tooltip="showTimeTooltip"
    ...
    <div v-show="realtime.picture.hover" class="console-realtime-data-item-picture" :style="realtime.picture.pictureStyle">
      <el-image
        :src="realtime.picture.picture"
      >
...
.console-container {
  ...
  .console-left-block {
    ...
    .console-monitor-point {
      ...
      ::v-deep .webcam-monitor-container {
        margin-bottom: 32px;
      }
