<template>
  <div ref="searchCondition" class="search-condition-container">
    <div class="expand-from-block" :style="expandFromHeight">
      ...
      >
        <div
          v-for="(div,divIndex) in dealedSearchFormData"
          :key="divIndex"
          class="form-row-block"
        >
          <el-form-item
            v-for="form in div"
            :key="form.prop"
          ...
          >
            <el-input
              ...
              v-model.trim="componentOption.data[form.prop]"
            ...
            <el-select
              ...
              v-model="componentOption.data[form.prop]"
              :style="{'width':form.width + 'px'}"
              :disabled="form.disabled"
              :size="elementSize"
              :placeholder="form.placeholder"
              clearable
              @change="selectChange(form.prop,form.isCascader)"
            >
              <el-option
                v-for="sel in form.option"
                :key="sel.value"
                :label="sel.label"
                :value="sel.value"
              />
