<template>
    <div class="dialog-shell-container">
        <el-dialog :title="dialogOption.title" v-model="dialogOption.show"
            :custom-class="dialogOption.customClass" :width="dialogOption.width" :class="innerClass"
            :fullscreen="dialogOption.fullscreen" :modal="dialogOption.modal" :show-close="dialogOption.showClose"
            :close-on-click-modal="dialogOption.clickClose" :close-on-press-escape="dialogOption.pressClose"
            :append-to-body="dialogOption.appendToBody" :before-close="closeDialog">
            ...
            <component :is="dialogOption.component.name" ref="component"
                :component-option="dialogOption.component.option" />
            <template v-slot:footer>
                <span class="dialog-footer">
                    <span v-if="dialogOption.errorMessage" class="dialog-footer-message">{{ dialogOption.errorMessage
}}</span>
                    <button-group ref="buttonGroup" :component-option="dialogOption.buttons" />
                </span>
            </template>
